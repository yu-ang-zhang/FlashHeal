            ...
            public void onClick(View view) {
                for (food_items_model food: db.getAllfooditems()
                    ...
                    if(food.getfood_item().equals(food1.getText().toString() + " (100 g.)")){
                        ...
                        l.add(food1.getText().toString(),food.getcalorie() * Integer.parseInt(weight1.getText().toString())/100);
                    }
                    if(food.getfood_item().equals(food2.getText().toString() + " (100 g.)")){
                        ...
                        l.add(food2.getText().toString(),food.getcalorie() * Integer.parseInt(weight2.getText().toString())/100);
                    }
                    if(food.getfood_item().equals(food3.getText().toString() + " (100 g.)")){
                        ...
                        l.add(food3.getText().toString(),food.getcalorie() * Integer.parseInt(weight3.getText().toString())/100);
                    }
                    if(food.getfood_item().equals(food4.getText().toString() + " (100 g.)")){
                        ...
                        l.add(food4.getText().toString(),food.getcalorie() * Integer.parseInt(weight4.getText().toString())/100);
                    }
                    if(food.getfood_item().equals(food5.getText().toString() + " (100 g.)")){
                        ...
                        l.add(food5.getText().toString(),food.getcalorie() * Integer.parseInt(weight5.getText().toString())/100);
                    }
                    if(food.getfood_item().equals(food6.getText().toString() + " (100 g.)")){
                        ...
                        l.add(food6.getText().toString(),food.getcalorie() * Integer.parseInt(weight6.getText().toString())/100);
                    }
                }
